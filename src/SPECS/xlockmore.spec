...
%build
%configure --with-crypt --enable-pam --enable-syslog --disable-setuid --disable-mb --without-motif --without-gtk2 --without-mesa --without-opengl
%{__make} %{?_smp_mflags}
...
- Hacked Fedora Core 29 SPEC file removing GL and Motif versions for AlmaLinux 8.9
